...
/// The Deep: depth and best, no course code (every dive is a new corridor).
String deepShareText({required int metres, required int best, required int attempts}) {
  final bestLine = best > metres ? ' · best $best m' : (best == metres && attempts > 1 ? ' · new best' : '');
  return '$kGameName · The Deep\n'
      '🌊 $metres m$bestLine · dive $attempts\nhttps://$kShareUrl/?deep=1';
}
