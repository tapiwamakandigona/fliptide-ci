...
const flipCatalog = <String, List<String>>{
  // 0.4.0 — The Deep, sound & feel
  'THE DEEP': ['LES ABYSSES', 'LAS PROFUNDIDADES', 'AS PROFUNDEZAS'],
  'endless · no finish line': ['sans fin · pas de ligne d’arrivée', 'sin fin · sin meta', 'sem fim · sem linha de chegada'],
  'no finish line · how deep can you go?': ['pas de ligne d’arrivée · jusqu’où irez-vous ?', 'sin meta · ¿hasta dónde llegarás?', 'sem linha de chegada · até onde você vai?'],
  'best': ['record', 'récord', 'recorde'],
  'dive': ['plongée', 'inmersión', 'mergulho'],
  'dives': ['plongées', 'inmersiones', 'mergulhos'],
  'DIVE AGAIN': ['REPLONGER', 'VOLVER A BAJAR', 'MERGULHAR DE NOVO'],
  'dive {number}': ['plongée {number}', 'inmersión {number}', 'mergulho {number}'],
  'Every dive is a new corridor. It gets harder the deeper you go.': ['Chaque plongée est un nouveau couloir. Plus vous descendez, plus c’est dur.', 'Cada inmersión es un pasillo nuevo. Cuanto más bajas, más difícil.', 'Cada mergulho é um corredor novo. Quanto mais fundo, mais difícil.'],
  'tap anywhere to dive again': ['touchez pour replonger', 'toca para volver a bajar', 'toque para mergulhar de novo'],
  'new best depth': ['nouveau record de profondeur', 'nueva profundidad récord', 'nova profundidade recorde'],
  'THE BOTTOM': ['LE FOND', 'EL FONDO', 'O FUNDO'],
  'you touched the bottom of the Deep': ['vous avez touché le fond des Abysses', 'tocaste el fondo de las Profundidades', 'você tocou o fundo das Profundezas'],
  'SETTINGS': ['RÉGLAGES', 'AJUSTES', 'AJUSTES'],
  'Music': ['Musique', 'Música', 'Música'],
  'Sound effects': ['Effets sonores', 'Efectos de sonido', 'Efeitos sonoros'],
  'Vibration': ['Vibration', 'Vibración', 'Vibração'],
  'flips': ['retournements', 'giros', 'giros'],
  'deaths': ['morts', 'muertes', 'mortes'],
  'deepest': ['plus profond', 'más profundo', 'mais fundo'],
  'Original soundtrack by Tsoro Studios': ['Bande originale par Tsoro Studios', 'Banda sonora original de Tsoro Studios', 'Trilha sonora original de Tsoro Studios'],
