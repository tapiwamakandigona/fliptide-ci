                    ...
                    builder: (_, p, _) => ClipRRect(
                      ...
                      child: Stack(
                        children: [
                          ...
                          // The fill eases towards the sim value so restarts snap
                          // back and progress glides instead of ticking.
                          AnimatedFractionallySizedBox(
                            ...
                            child: Container(
                              height: 10,
                              decoration: const BoxDecoration(gradient: LinearGradient(colors: [Palette.playerDark, Palette.player])),
                            ),
                          ),
                        ],
                      ),
                    ...
                    if (!won) {
                      ...
                      return TweenAnimationBuilder<double>(
                        ...
                        builder: (_, k, child) => Opacity(
                          ...
                          child: Transform.scale(scale: 0.86 + 0.14 * k, child: child),
                        ),
                        child: card,
                      );
                    }
              ...
              return SizedBox(
                ...
                child: Center(
                  child: ValueListenableBuilder<RunState>(
                    ...
                    builder: (_, ph, _) {
                      if (ph == RunState.running) {
                        // Title screen (attempt 0): the Supporter entry point, then the
                        // cross-promo footer (directive 05b). Both vanish the moment the first run
                        // starts; neither is ever on the death / CLEARED cards.
                        return ValueListenableBuilder<int>(
                          valueListenable: attempts,
                          builder: (_, a, _) => a == 0
                              ? Column(
